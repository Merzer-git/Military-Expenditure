...
def render_no_parametrico(df):
    """Lógica completa de la pestaña No Paramétricos"""
    ...
    tabs = st.tabs(['Prueba de Bondad de Ajuste', 'Prueba de Independencia', 'Prueba de Homogeneidad'])
    ...
    with tabs[1]:
        #LOGICA DE INDEPENDENCIA USANDO PRUEBA DE CHI CUADRADO
        pass

    with tabs[2]:
        #LOGICA DE HOMOGENEIDAD USANDO PRUEBA DE CHI CUADRADO
        pass
...
[TAB] No Paramétricos
   |
   +-- [SUB-TAB 1] Bondad de Ajuste
   |      [Columna 1: Config]           [Columna 2: Gráfico]
   |      - Variable: [Spending_B v]    - Histograma (Barras Azules)
   |      - Año: [2024]                 - Línea Teórica (Roja Punteada)
   |      - Dist: [Normal v]
   |      - [BTN CALCULAR]
   |
   +-- [SUB-TAB 2] Independencia & Homogeneidad
          [Columna 1: Variables]        [Columna 2: Resultados]
          - Var 1 (Filas): [Region v]   - Heatmap (Mapa de Calor)
          - Var 2 (Cols): [Spending v]  - Tabla de Contingencia
          - Año: [2024]                 - P-Valor Chi-Cuadrado
          - [BTN CALCULAR]
"""